...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService",
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "R8+rlxlpjerL3KeZ3e1PcWoXprG0EfuD9HBxIvf8XgBYZLm+ExW7iKHLJJtjJ6YGsnd0x5kHyvpdizO5lHyJrA=="));
    ...
    private CfnCluster createMskCluster() {
        ...
        int numberOfAzs = privateSubnetIds.size();
        int numberOfBrokers = numberOfAzs; // minimum multiple
